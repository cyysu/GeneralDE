...
{
public:
    ContextImpl(uipp_sprite_render_ext & module, WorldRes & world_res)
    ...
    virtual uipp_sprite_render_ext & module(void) {
        return m_module;
    }

    virtual uipp_sprite_render_ext const & module(void) const {
        return m_module;
    }
...
private:
    ...
    uipp_sprite_render_ext & m_module;
...
Context & Context::install(World & world) {
    return ContextImpl::install(
        dynamic_cast<uipp_sprite_render_ext &>(uipp_sprite_render::instance(world.app())),
        world);
}
