    ...
    uint8_t process_x, uint8_t process_y)
{
    ...
    UI_SPRITE_2D_PAIR flip_to_pos;
    UI_SPRITE_2D_PAIR self_pos;
    uint8_t flip_x;
    uint8_t flip_y;
...
static void ui_sprite_2d_flip_follow_entity(void * ctx, ui_sprite_event_t evt) {
    ...
    strncpy(flip->m_flip_entity_name, evt_data->entity_name, sizeof(flip->m_flip_entity_name));
...
int ui_sprite_2d_flip_enter(ui_sprite_fsm_action_t fsm_action, void * ctx) {
...
void ui_sprite_2d_flip_update(ui_sprite_fsm_action_t fsm_action, void * ctx, float delta) {
    ui_sprite_2d_flip_t flip = ctx;
    ui_sprite_2d_module_t module = flip->m_module;
	ui_sprite_entity_t entity = ui_sprite_fsm_action_to_entity(fsm_action);
...
void ui_sprite_2d_flip_exit(ui_sprite_fsm_action_t fsm_action, void * ctx) {
}

int ui_sprite_2d_flip_init(ui_sprite_fsm_action_t fsm_action, void * ctx) {
	ui_sprite_2d_flip_t flip = ui_sprite_fsm_action_data(fsm_action);
...
int ui_sprite_2d_flip_copy(ui_sprite_fsm_action_t to, ui_sprite_fsm_action_t from, void * ctx) {
    ui_sprite_2d_flip_init(to, ctx);
    return 0;
}

void ui_sprite_2d_flip_clear(ui_sprite_fsm_action_t fsm_action, void * ctx) {
}
