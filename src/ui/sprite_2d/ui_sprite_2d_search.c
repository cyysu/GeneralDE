    ...
    ui_sprite_2d_transform_t found_entity_transform)
{
    ...
    strncpy(result_data.found_entity_name, ui_sprite_entity_name(found_entity), sizeof(result_data.found_entity_name));
    result_data.found_entity_pos = ui_sprite_2d_transform_origin_pos(found_entity_transform);
...
int ui_sprite_2d_in_shape(ui_sprite_event_t evt, UI_SPRITE_2D_PAIR entity_pos, UI_SPRITE_2D_PAIR target_pos){
    ...
    if(evt_data->shape.type == UI_SPRITE_2D_SHAPE_BOX){
       ...
       UI_SPRITE_2D_PAIR center = evt_data->shape.data.circle.center;
       if( cpe_math_distance(entity_pos.x - center.x, entity_pos.y - center.y, target_pos.x, target_pos.y) 
        ...
        UI_SPRITE_2D_PAIR center = evt_data->shape.data.sector.center;
        if( cpe_math_distance(entity_pos.x - center.x, entity_pos.y - center.y, target_pos.x, target_pos.y) 
            < evt_data->shape.data.circle.radius){
    ...
    ui_sprite_event_t evt, ui_sprite_2d_search_cmp_node_fun_t cmp_policy)
{
    ...
    UI_SPRITE_2D_PAIR entity_pos = ui_sprite_2d_transform_origin_pos(entity_transform);
    ui_sprite_2d_module_t module = search->m_module;
    ...
    ui_sprite_2d_search_t search, ui_sprite_entity_t entity, ui_sprite_event_t evt, ui_sprite_entity_it_t entity_it)
{
    ...
    strncpy(buf, evt_data->search_policy, sizeof(buf));
