...
void ui_sprite_ctrl_turntable_update_members_transform(ui_sprite_ctrl_turntable_t turntable) {
    ...
    float scale = ui_sprite_2d_transform_scale(transform);
    ...
    TAILQ_FOREACH(member, &turntable->m_members, m_next_for_turntable) {
        ...
        ui_sprite_anim_sch_t member_anim_sch = ui_sprite_anim_sch_find(member_entity);
        float member_scale = 1.0f;
        ...
        if (anim_sch && member_anim_sch) {
            ui_sprite_anim_sch_set_render_priority(
                member_anim_sch,
                ui_sprite_anim_sch_render_priority(anim_sch) + (angel_to_focuse <= 90.0f ? 1 : -1));
        }
        ...
        ui_sprite_2d_transform_set_scale(member_transform, scale * member_scale);
    }
}
...
int ui_sprite_ctrl_turntable_pos(ui_sprite_ctrl_turntable_t turntable, UI_SPRITE_2D_PAIR * pos) {
