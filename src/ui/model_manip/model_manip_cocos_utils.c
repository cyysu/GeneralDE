...
UI_IMG_BLOCK * cocos_build_img_block(cfg_t frame_cfg, ui_ed_obj_t module_obj, uint32_t img_id, error_monitor_t em) {
    ...
    img_block_obj = ui_ed_obj_new(module_obj, ui_ed_obj_img_block);
    ...
    strncpy(img_block->name, cfg_name(frame_cfg), sizeof(img_block->name));
    img_block->src_x = x;
    img_block->src_y = y;
    ...
    uint32_t frame_duration, ui_manip_action_import_frame_position_t frame_position, error_monitor_t em)
{
    ...
    actor_frame_obj = ui_ed_obj_new(layer_obj, ui_ed_obj_actor_frame);
    ...
    if (cfg_get_uint8(frame_cfg, "rotated", 0)) {
        ...
        case ui_manip_action_import_frame_center:
            img_ref->trans.local_trans.trans.value[0] = - ((int)img_block->src_h / 2);
            img_ref->trans.local_trans.trans.value[1] = (int)img_block->src_w / 2;
            break;
        ...
        case ui_manip_action_import_frame_center_right:
            img_ref->trans.local_trans.trans.value[0] = - (int)img_block->src_h;
            img_ref->trans.local_trans.trans.value[1] = (int)img_block->src_w / 2;
            break;
        ...
        case ui_manip_action_import_frame_top_center:
            img_ref->trans.local_trans.trans.value[0] = - ((int)img_block->src_h / 2);
            img_ref->trans.local_trans.trans.value[1] = (int)img_block->src_w;
            break;
