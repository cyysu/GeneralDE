...
void ui_sprite_event_handler_free(const ui_sprite_world_t world, ui_sprite_event_handler_t handler) {
    ui_sprite_repository_t repo = world->m_repo;
...
int ui_sprite_event_analize_head(
    ...
    ui_sprite_repository_t repo, char * event_def)
{
...
static int ui_sprite_event_build_and_enqueue_i(
    ...
    char * event_def, dr_data_source_t data_source)
{
    ui_sprite_pending_event_t processing_evt;
    ui_sprite_event_meta_t event_meta;
    char * event_args;
    ...
    if (ui_sprite_event_analize_head(&event_meta, &event_args, repo, event_data) != 0) {
