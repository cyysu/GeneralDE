...
void room_svr_op_join(room_svr_t svr, dp_req_t pkg_head, dp_req_t pkg_body) {
    ...
    req = &((SVR_ROOM_PKG*)dp_req_data(pkg_body))->data.svr_room_req_join;
    ...
    user->m_data->user_at_svr_type = set_pkg_from_svr_type(pkg_body);
    user->m_data->user_at_svr_id = set_pkg_from_svr_id(pkg_body);
