...
$(product).cpe-dr.pro.source:=$(addprefix $(product-base)/../../svr/pro/, cli/svr_room_data.xml cli/svr_room_pro.xml)
$(product).cpe-dr.pro.h.output:=share/protocol/svr/room
$(product).cpe-dr.pro.h.with-traits:=pro_meta_traits.cpp
$(product).cpe-dr.pro.c.output:=share/protocol/svr/room/metalib.c
