...
extern "C" char g_metalib_svr_center_pro[];

namespace Svr { namespace Center {

class CenterSvrLogic : public Cpe::Nm::Object {
public:
    static cpe_hash_string_t NAME;

    CenterSvrLogic(Gd::App::Application & app, Gd::App::Module & module, Cpe::Cfg::Node & cfg)
...
private:
    ...
    static int CenterSvr_pkg_init(logic_context_t context, bpg_pkg_t pkg, void * ctx) {
...
GDPP_APP_MODULE_DEF(CenterSvrLogic, CenterSvrLogic);
