...
$(product).cpe-dr.pro.source:=$(addprefix $(product-base)/../../svr/pro/, cli/svr_mail_pro.xml)
$(product).cpe-dr.pro.h.output:=share/protocol/svr/mail
$(product).cpe-dr.pro.h.with-traits:=pro_meta_traits.cpp
$(product).cpe-dr.pro.c.output:=share/protocol/svr/mail/metalib.c
