...
$(product).cpe-dr.pro.source:=$(addprefix $(product-base)/../../svr/pro/, cli/svr_match_data.xml cli/svr_match_pro.xml)
$(product).cpe-dr.pro.h.output:=share/protocol/svr/match
$(product).cpe-dr.pro.h.with-traits:=pro_meta_traits.cpp
$(product).cpe-dr.pro.c.output:=share/protocol/svr/match/metalib.c
