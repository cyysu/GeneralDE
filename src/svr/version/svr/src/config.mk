...
$(product).cpe-dr.pro.source:=$(addprefix $(product-base)/../pro/, cli/svr_version_pro.xml)
...
$(product).cpe-dr.pro-use.source:=$(addprefix $(product-base)/../pro/, cli/svr_version_pro.xml)
