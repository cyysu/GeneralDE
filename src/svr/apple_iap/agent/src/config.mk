...
$(product).cpe-dr.pro.source:=$(addprefix $(product-base)/../../svr/pro/, cli/svr_apple_iap_data.xml cli/svr_apple_iap_pro.xml)
$(product).cpe-dr.pro.h.output:=share/protocol/svr/apple_iap
$(product).cpe-dr.pro.h.with-traits:=pro_meta_traits.cpp
$(product).cpe-dr.pro.c.output:=share/protocol/svr/apple_iap/metalib.c
