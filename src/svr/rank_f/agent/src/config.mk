...
$(product).cpe-dr.pro.source:=$(addprefix $(product-base)/../../svr/pro/, cli/svr_rank_f_pro.xml)
$(product).cpe-dr.pro.h.output:=share/protocol/svr/rank_f
$(product).cpe-dr.pro.h.with-traits:=pro_meta_traits.cpp
$(product).cpe-dr.pro.c.output:=share/protocol/svr/rank_f/metalib.c
