...
int main(int argc, char * argv[]) {
    ...
    struct arg_int *  run_app_id = arg_int1(NULL, "app-id", NULL,    "app id");
    struct arg_int *  run_game_id = arg_int1(NULL, "game-id", NULL,    "game id");
    struct arg_end  * run_end = arg_end(20);
    void* run_argtable[] = { run, run_pidfile, run_root, run_app_id, run_game_id, run_end };
    int run_nerrors;
