...
$(product).cpe-dr.pro.source:=$(addprefix $(product-base)/../../svr/pro/, cli/svr_rank_g_pro.xml)
$(product).cpe-dr.pro.h.output:=share/protocol/svr/rank_g
$(product).cpe-dr.pro.h.with-traits:=pro_meta_traits.cpp
$(product).cpe-dr.pro.c.output:=share/protocol/svr/rank_g/metalib.c
