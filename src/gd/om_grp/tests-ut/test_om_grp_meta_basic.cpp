...
TEST_F(OmGrpMetaTest, normal_basic) {
    ...
    EXPECT_STREQ(
        "om_grp_meta: name=TestObj, page-size=256, class-id=1, obj-size=4, page-count=1, size-buf-start=4, size-buf-count=0\n"
...
TEST_F(OmGrpMetaTest, list_basic) {
    ...
    EXPECT_STREQ(
        "om_grp_meta: name=TestObj, page-size=256, class-id=1, obj-size=6, page-count=1, size-buf-start=4, size-buf-count=1\n"
...
TEST_F(OmGrpMetaTest, basic_multi) {
    ...
    EXPECT_STREQ(
        "om_grp_meta: name=TestObj, page-size=256, class-id=1, obj-size=14, page-count=3, size-buf-start=12, size-buf-count=1\n"
        "    entry1: entry-type=normal, data=type=AttrGroup1, page-begin=0, page-count=1, class-id=2, obj-size=4, obj-align=1\n"
