...
GL_APICALL int          GL_APIENTRY glGetAttribLocation (GLuint program, const char* name){ return 0; }
...
GL_APICALL int          GL_APIENTRY glGetUniformLocation (GLuint program, const char* name){ return 0; }
