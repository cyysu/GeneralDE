...
public:
    operator conn_logic_sp_t() const { return (conn_logic_sp_t)this; }

    Gd::App::Application & app(void) { return *(Gd::App::Application*)conn_logic_sp_app(*this); }
    Gd::App::Application const & app(void) const { return *(Gd::App::Application*)conn_logic_sp_app(*this); }

    const char * name(void) const { return conn_logic_sp_name(*this); }
