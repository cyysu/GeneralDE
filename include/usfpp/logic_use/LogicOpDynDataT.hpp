...
public:
    ...
    LogicOpDynDataT(LogicOpContext & context) {
        m_data = context.checkCreateData<DataT>();
    }

    LogicOpDynDataT(LogicOpStackNode & stackNode) {
        m_data = stackNode.checkCreateData<DataT>();
    }

    LogicOpDynDataT(LogicOpRequire & require) {
