...
$(call assert-not-null,$1.struct-log.$3.category)
...
$(eval r.$1.$2.struct-log.$3.category:=$($1.struct-log.$3.category))
...
$(call c-source-to-object,$(r.$1.c.sources),$3): $(r.$1.$2.struct-log.$3.generated.h)
...
$(r.$1.$2.struct-log.$3.generated.c) $(r.$1.$2.struct-log.$3.generated.h): $(r.$1.$2.struct-log.$3.source) $(struct-log-tool)
	...
	$(CPDE_PERL) $(struct-log-tool) --input-file $(r.$1.$2.struct-log.$3.source) \
                       ...
                       --category $(r.$1.$2.struct-log.$3.category)
